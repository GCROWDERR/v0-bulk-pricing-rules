...
let _ruleSetCounter = 0
export function generateRuleSetId(): string {
  _ruleSetCounter++
  const ts = Date.now().toString(36).toUpperCase()
  const seq = _ruleSetCounter.toString().padStart(3, '0')
  return `RS-${ts}-${seq}`
}
...
export const generateSampleRules = (): PricingRule[] => {
  const rules: PricingRule[] = [
    // Conventional Rules
    {
      ...
      RuleSetId: 'demo-set-conv-30yr',
      RuleSetName: 'Conv 30yr Purchase Matrix',
    ...
    {
      // FHA Adjustments Rule Set
      RuleId: 1050,
      RuleDescription: 'FHA Adj FICO 760+ Low LTV',
      RuleSetId: 'demo-set-fha-adj',
      RuleSetName: 'FHA Rate Adjustments',
      Lenders: getLenders(1017),
      Fee: 0,
      Price: 0.5,
      CompPercent: 2.75,
    ...
    {
      RuleId: 1051,
      RuleDescription: 'FHA Adj FICO 720-759 Low LTV',
      RuleSetId: 'demo-set-fha-adj',
      RuleSetName: 'FHA Rate Adjustments',
      Lenders: getLenders(1018),
      Fee: 125,
    ...
    {
      RuleId: 1052,
      RuleDescription: 'FHA Adj FICO 680-719 Low LTV',
      RuleSetId: 'demo-set-fha-adj',
      RuleSetName: 'FHA Rate Adjustments',
      Lenders: getLenders(1019),
      Fee: 250,
    ...
    {
      RuleId: 1053,
      RuleDescription: 'FHA Adj FICO 760+ High LTV',
      RuleSetId: 'demo-set-fha-adj',
      RuleSetName: 'FHA Rate Adjustments',
      Lenders: getLenders(1020),
      Fee: 0,
    ...
    {
      RuleId: 1054,
      RuleDescription: 'FHA Adj FICO 720-759 High LTV',
      RuleSetId: 'demo-set-fha-adj',
      RuleSetName: 'FHA Rate Adjustments',
      Lenders: getLenders(1021),
      Fee: 125,
    ...
    {
      RuleId: 1055,
      RuleDescription: 'FHA Adj FICO 680-719 High LTV',
      RuleSetId: 'demo-set-fha-adj',
      RuleSetName: 'FHA Rate Adjustments',
      Lenders: getLenders(1022),
      Fee: 375,
